...
//                throw new IllegalArgumentException("knowledge should be pair");
//            }
...
//            }
//            if (c == RIGHT) {
//                String key = s.substring(keyStartIdx + 1, i);
//                sb.append(map.getOrDefault(key, UNKNOWN));
//                keyStartIdx = -1; // 重置起始点位
//                continue;
//            }
//            if (keyStartIdx == -1) {
//                // 不在读()内的内容
