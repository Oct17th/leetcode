...
// Related Topics 哈希表 链表 双指针 👍 1692 👎 0
...
//        //return oMmultiplyN(headA, headB);
//        //return oPlusN(headA, headB);
//        return doubleIndex(headA, headB);
//    }
//
//    /**
//     * 双指针
...
//     * @return
//     */
//    private ListNode doubleIndex(ListNode headA, ListNode headB) {
...
//     * @return
//     */
//    private ListNode oPlusN(ListNode headA, ListNode headB) {
//        // 遍历headA先放到一个set里
...
//     * @return
//     */
//    private ListNode oMmultiplyN(ListNode headA, ListNode headB) {
//        if (headA == null || headB == null) {
//            return null;
//        }
//
